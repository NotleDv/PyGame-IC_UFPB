...
while True:
    ...
    if tela_atual == "menu":
        ...
        if campo_ativo == 2  and cursor_visivel:
            ...
            pygame.draw.line(tela, (60, 60, 60), (x_cursor, y_inicio), (x_cursor, y_fim), 2)
        #pygame.draw.rect(tela, (200,200,200),(480,610,tamanho_botaor[0],tamanho_botaor[1])) #hitbox do botão de retorno
        #pygame.draw.rect(tela, (200,200,200),(137,338,430,60))
        #pygame.draw.rect(tela, (200,200,200),(137,500,430,60))
